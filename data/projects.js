...
exists."
	...
	},
	{
		...
		"desc" : "Develop an efficient strategy that allows coala to maintain a number \
of plugins for different editors. We consider any bit of code *supported* only if we have regular \
continuous integration and tests running to ensure it's functionality. coala features quite some \
editor plugins already, none of which are *supported* according to the above definition. The goal \
of this project is to plan, introduce and configure a testing routine that allows coala to ensure \
the functioning of it's editor plugins at all times. A viable approach might be to set up weekly \
tests for the current editor plugins. For some editors like sublime and gedit, running tests is \
not easy and there is no api to do it. In such cases we  would want to use dogtail (a GUI tester) \
or a similar tool to do this.",
		"requirements" : [
			"The proposal has to provide a convincing strategy for testing editor plugins",
			"The applicant should have one patch accepted to any of the coala projects."
		],
		"difficulty" : "medium",
		"issues" : [
		...
		"milestones" : {
			"GSoC 2017 Coding Starts" : [
				"A cEP for the testing strategy has been merged."
			],
			"GSoC 2017 Midterm" : [
